System.register(["./Index"], function (exports_1, context_1) {
    ...
    var Alina, undefinedOrNull, definedNotNull, AlRepeat;
    return {
        setters: [
            function (Alina_1) {
                Alina = Alina_1;
        ...
        execute: function () {
            undefinedOrNull = Alina.undefinedOrNull;
            definedNotNull = Alina.undefinedOrNull;
            AlRepeat = /** @class */ (function () {
                function AlRepeat() {
                    this.itemContexts = [];
                }
